      ...
      <form onSubmit={save} onChange={() => { setMessage(''); setError(''); }}>
        <fieldset disabled={saving} className="space-y-8 border border-slate-700 bg-slate-900/80 p-6">
          <div>
            ...
            <p id="username-help" className="mt-2 text-sm text-slate-400">Your name in new matches. Use up to 24 characters.</p>
          ...
          <div>
            ...
            <p id="volume-help" className="mt-2 text-sm text-slate-400">Controls the volume of interface and game sounds.</p>
          </div>
