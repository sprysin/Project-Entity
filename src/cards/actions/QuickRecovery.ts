...
const effect: IEffect = {
    onActivate: buildEffect([
        Cost.SelectDiscardRecovery("Select Level 3 or Lower Entity", (c) => c.type === CardType.ENTITY && c.level <= 3),
    ...
    canActivate: buildCondition([
        ...
        Condition.DiscardMatchesFilter('active', (c) => c.type === CardType.ENTITY && c.level <= 3)
    ])
};
